  ...
  return (
    <>   
        ...
        <div className="left-container">
            ...
            <p>
                Address: <span>College of Science and Technology Book Store</span>
            </p>
    ...
    <div className="catagories-container">
      ...
      <div className="catagories">
        <div
          className="cat"
          onClick={() => redirectIfNotLoggedIn(() => router.push('/users/Online_ordering#Fiction'))}
        >
          Fiction
        </div>
        <div
          className="cat"
          onClick={() => redirectIfNotLoggedIn(() => router.push('/users/Online_ordering#Science-fiction'))}
        >
          Science Fiction
        </div>
        <div
          className="cat"
          onClick={() => redirectIfNotLoggedIn(() => router.push('/users/Online_ordering#Advanture'))}
        >
          Adventure
        </div>
        <div
          className="cat"
          onClick={() => redirectIfNotLoggedIn(() => router.push('/users/Online_ordering#Biography'))}
        >
          Biography
        </div>
        <div
          className="cat"
          onClick={() => redirectIfNotLoggedIn(() => router.push('/users/Online_ordering#Thriller'))}
        >
          Thriller
        </div>
        <div
          className="cat"
          onClick={() => redirectIfNotLoggedIn(() => router.push('/users/Online_ordering#Love'))}
        >
          Love
        </div>
        <div
          className="cat"
          onClick={() => redirectIfNotLoggedIn(() => router.push('/users/Online_ordering#History'))}
        >
          History
        </div>
        <div
          className="cat"
          onClick={() => redirectIfNotLoggedIn(() => router.push('/users/Online_ordering#Adult'))}
        >
          Adult
        </div>
      </div>
